...
const SalesBook = () => {
  const [sales, setSales] = useState([
    { id: 1, date: '2024-01-15', customerName: 'Reliance Industries', invoiceNumber: 'INV-001', description: 'IT Services', amount: 75000, status: 'paid' },
    { id: 2, date: '2024-01-18', customerName: 'Tata Consultancy', invoiceNumber: 'INV-002', description: 'Software Development', amount: 120000, status: 'pending' },
    { id: 3, date: '2024-01-20', customerName: 'Infosys Limited', invoiceNumber: 'INV-003', description: 'Consulting Services', amount: 85000, status: 'paid' },
    { id: 4, date: '2024-01-25', customerName: 'Wipro Technologies', invoiceNumber: 'INV-004', description: 'Maintenance Contract', amount: 45000, status: 'pending' },
  ]);
  ...
  const filteredSales = sales.filter(sale => {
    ...
    if (filters.customer && !sale.customerName.toLowerCase().includes(filters.customer.toLowerCase())) return false;
    return true;
  });
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Manage and track sales transactions</p>
            </div>
          </div>
          <div className="flex items-center">
          ...
          <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-gray-700">
                Showing <span className="font-medium">1</span> to <span className="font-medium">{filteredSales.length}</span> of{' '}
          ...
          <div className="relative mx-auto p-6 border w-full max-w-md shadow-xl rounded-lg bg-white">
            ...
            <div className="mt-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="sale-amount" className="block text-sm font-medium text-gray-700 mb-1">
                    Amount (₹)
                  </label>
                ...
                <div>
                  <label htmlFor="sale-description" className="block text-sm font-medium text-gray-700 mb-1">
                    Description
                  </label>
                  <textarea
                    id="sale-description"
